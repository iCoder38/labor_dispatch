//
//  DDeliveredHistoryDetails.swift
//  Alien Broccoli
//
...
class DDeliveredHistoryDetails: UIViewController {
    
    let cellReuseIdentifier = "dDeliveredHistoryDetailsTableCell"
...
extension DDeliveredHistoryDetails: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.row == 0 {
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: "cellOne") as! DDeliveredHistoryDetailsTableCell
            ...
            let cell2 = tableView.dequeueReusableCell(withIdentifier: "cellTwo") as! DDeliveredHistoryDetailsTableCell
            ...
            let cell3 = tableView.dequeueReusableCell(withIdentifier: "cellThree") as! DDeliveredHistoryDetailsTableCell
            ...
            let cell4 = tableView.dequeueReusableCell(withIdentifier: "cellFour") as! DDeliveredHistoryDetailsTableCell
            
            cell4.lblShippingCurrentStatus.text      = "Complete" // (self.dict["cardType"] as! String)
            cell4.lblShippingExpectedDelivery.text   = "Delivery Status : Complete"// (self.dict["deliveryDay"] as! String)
...
extension DDeliveredHistoryDetails: UITableViewDelegate {
